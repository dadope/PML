# SOURCE: https://github.com/LeviBorodenko/motionblur/
import numpy as np
...
class MotionBlur(Transform):
    def __init__(self, size: tuple = (61, 61), intensity: float = 0.5):
        self._kernel = Kernel(size=size, intensity=intensity)
        super().__init__()

    def _transform(self, inpt: Any, params: Dict[str, Any]) -> Any:
        return self._kernel.applyTo(inpt, keep_image_dim=True)
